/**
 * App-level config — generic asset paths not tied to a single puzzle.
 * Per-puzzle assets live in each stage's own config.js.
 */
...
export const SEFY_AVATAR = 'assets/briefings/sefy_avatar.mp4';
